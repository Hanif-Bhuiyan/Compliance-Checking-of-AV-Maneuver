...
class query_behaviour:


    def query_trigger_for_behaviour(self, query, vehicle_name):
        ...
        c = self.query.replace('ab:', onto_name)
        c = c.replace('time', instance2)
        #if(vehicle_name == "vehicle"):
        #    pass
        #else:
        c =c.replace('vehicle', vehicle_name)
