...
class primary_checking_of_av_tv:

    def checking_of_av_tv(self,which_av, which_tv):
        ...
        primary_distance = av_distance - tv_distance
        return primary_distance

    '''
        if (position_x_of_av > 0):

            distance = tv_distance - av_distance
            return distance
        else:
            distance = av_distance - tv_distance
            return distance
